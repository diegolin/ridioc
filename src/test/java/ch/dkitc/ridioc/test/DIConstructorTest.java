...
public class DIConstructorTest {
    ...
    public void constructorPositiveTests() {
        ...
        new DIConstructor(BeanWithDefaultConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);

        assertTrue(AnotherBeanWithDefaultConstructorImpl.class.getConstructors().length >= 1);
        new DIConstructor(AnotherBeanWithDefaultConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
    }

    @Test
    public void constructorNegativeTests() {
        try {
            new DIConstructor(null, wrappedPrimitiveTypeMap, paranamer);
        ...
        assertTrue(AnotherBeanWithDefaultConstructorImpl.class.getConstructors().length >= 1);
        try {
            new DIConstructor(AnotherBeanWithDefaultConstructorImpl.class.getConstructors()[0], null, paranamer);
            fail("should throw 'java.lang.IllegalArgumentExeption'");
        }
        catch (IllegalArgumentException ex) {
            // o.k.
    ...
    private void getParamXyzPositiveTests_checkJavaLangStringArray() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithStringArrayConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
    ...
    private void getParamXyzPositiveTests_checkTypeArray() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithMultipleImplsArrayConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangStringList() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithStringListConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testStrings", diConstructor.getParamName(0));
    ...
    private void getParamXyzPositiveTests_checkTypeList() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithMultipleImplsListConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveByte() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveByteConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangByte() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithByteConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testByte", diConstructor.getParamName(0));
        assertEquals(Byte.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveShort() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveShortConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangShort() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithShortConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testShort", diConstructor.getParamName(0));
        assertEquals(Short.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveInteger() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveIntegerConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangInteger() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithIntegerConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveLong() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveLongConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangLong() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithLongConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testLong", diConstructor.getParamName(0));
        assertEquals(Long.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveFloat() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveFloatConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangFloat() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithFloatConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testFloat", diConstructor.getParamName(0));
        assertEquals(Float.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveDouble() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveDoubleConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangDouble() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithDoubleConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testDouble", diConstructor.getParamName(0));
        assertEquals(Double.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveCharacter() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveCharConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangCharacter() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithCharacterConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkPrimitiveBoolean() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithPrimitiveBooleanConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangBoolean() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithBooleanConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
        assertEquals("testBoolean", diConstructor.getParamName(0));
        assertEquals(Boolean.class, diConstructor.getParamType(0));
        assertEquals(0, diConstructor.getParamAnnotations(0).size());
    ...
    private void getParamXyzPositiveTests_checkJavaMathBigDecimal() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithBigDecimalConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaMathBigInteger() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithBigIntegerConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangString() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithStringConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangEnum() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithEnumConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkJavaLangDate() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithDateConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkSingleType() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithSingleTypeConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
        assertEquals(1, diConstructor.getParamCount());
    ...
    private void getParamXyzPositiveTests_checkMultipleTypes() {
        ...
        DIConstructor diConstructor = new DIConstructor(BeanWithMultipleTypesConstructorImpl.class.getConstructors()[0], wrappedPrimitiveTypeMap, paranamer);
